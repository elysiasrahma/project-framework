    ...
    <div class="overflow-x-auto rounded-lg border border-[#e2d3be] shadow-sm bg-white/70">
        <table class="min-w-full text-sm text-[#4b3b2b]">
            <thead class="bg-[#f1e5d1] text-left">
                <tr>
                    <th class="px-4 py-2 border text-center">Nama Jabatan</th>
            ...
            <tbody>
                ...
                <tr>
                    <td class="px-4 py-2 border text-center">{{ $position->nama_jabatan }}</td>
                    <td class="px-4 py-2 border text-center">Rp {{ number_format($position->gaji_pokok) }}</td>
